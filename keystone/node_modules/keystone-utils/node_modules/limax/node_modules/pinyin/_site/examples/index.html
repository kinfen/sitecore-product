...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <title>pinyin - 演示文档</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="generator" content="nico-spm 0.5.3" />
...
<script>
  ...
  <div class="body-wrapper">
      ...
      <p class="sidebar-version">Version: <a href="http://spmjs.io/package/pinyin" title="">2.5.0</a></p>
        <p class="sidebar-description" data-keyword="拼音">汉语拼音转换工具。</p>
        <a class="sidebar-source" href="https://github.com/hotoo/pinyin" target="_blank">View the Project</a>
        <ul class="sidebar-navigation" role="navigation">
          ...
          <li><a class="issue-link" href="https://github.com/hotoo/pinyin/issues" target="_blank">Issues</a></li>
        </ul>
...
<article class="hentry">
  <h1 class="entry-title">演示文档</h1>
  <div class="entry-content">
    <style>
textarea{width:90%; height:100px;}
</style>

<h3 id="输入汉字">输入<a href="?han=简体中文汉字">汉字</a><a href="#输入汉字" class="anchor">¶</a></h3><div>
  <textarea id="input"></textarea>
</div>

<h3 id="输出">输出<a href="#输出" class="anchor">¶</a></h3><div>
    ...
    ready(function() {
      ...
      seajs.use("../static/js/arale-qrcode.js?nowrap", function(QRCode) {
        ...
        if (location.hostname === 'localhost' || location.hostname === '127.0.0.1') {
          url = url.replace(location.hostname, '10.15.102.125');
        }
        var el = new QRCode({
          text: url,
          render: 'canvas',
